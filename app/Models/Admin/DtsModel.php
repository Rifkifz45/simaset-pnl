...
class DtsModel extends Model
{
    ...
    public function __construct(RequestInterface $request, $id)
    {
        parent::__construct();
        $this->db = db_connect();
    ...
    public function _get_datatables_query(){
        $i = 0;
        $this->dt = $this->db->table($this->table)->like('fields_id', $this->id['field'])->orderBy('kode_barang', 'asc')->orderBy('nup', 'ASC');
