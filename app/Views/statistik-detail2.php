  ...
  <body>
    ...
    <section class="body">
      <div class="container">
        ...
        <a href="<?= site_url('statistik-detail') ?>" class="btn btn-default"><i class="fa fa-arrow-left" aria-hidden="true"></i> Return</a>
        <div><br></div>
        <section role="main">
          <!-- start: page -->
            <section class="panel">
              <header class="panel-heading">
                ...
                <h2 class="panel-title">Statistik Barang Milik Negara (Group Berdasarkan Gedung)</h2>
              </header>
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-default">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="center">
                        <a href="javascript:void(0)" class="btn btn-primary btn-sm"><i class="fa fa-list-alt"></i> See Detail</a>
                      </td>
                    </tr>
                    <?php endforeach ?>
                  </tbody>
