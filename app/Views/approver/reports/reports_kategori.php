...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>DAFTAR DATA KATEGORI</title>
    <style>
      h1 {
      font-weight: bold;
      font-size: 16pt;
      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th class="text-center"> Sub-sub Kelompok </th>
            <th> Uraian </th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><?= $value['sub_kelompok'] ?></td>
            <td class="text-center"><?= $value['sub_sub_kelompok'] ?></td>
            <td><?= $value['uraian'] ?></td>
          </tr>
          <?php endforeach ?>
