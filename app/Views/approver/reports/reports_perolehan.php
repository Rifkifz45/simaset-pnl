      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th class="text-center"> Kode Perolehan </th>
            <th class="text-center"> Nama Perolehan </th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><?= $value['id_perolehan'] ?></td>
            <td><?= $value['uraian_perolehan'] ?></td>
          </tr>
          <?php endforeach ?>
          <?php if ($perolehan == NULL): ?>
            <tr>
