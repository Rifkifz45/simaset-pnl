      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th class="text-center" rowspan="2"> Luas </th>
            <th class="text-center" rowspan="2"> Tgl Perolehan </th>
            <th class="text-center" rowspan="2"> Letak / Alamat </th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= $value['nup'] ?></td>
            <td><?= number_format($value['luas_tanah_seluruhnya']) . " M2" ?></td>
