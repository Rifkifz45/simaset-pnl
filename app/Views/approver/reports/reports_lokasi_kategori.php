...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>DAFTAR DATA LOKASI KATEGORI</title>
    <style>
      h1 {
      font-weight: bold;
      font-size: 16pt;
  ...
  <body class="A4">
    <section class="sheet padding-10mm">
      ...
      <h1>LIST DATA LOKASI KATEGORI</h1>
      <br>
      <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          <?php foreach ($lokasi_kategori as $key => $value): ?>
          <tr>
            <td class="text-center"><?= $key+1 ?></td>
            <td class="text-center"><?= $value['id_kategori_lokasi'] ?></td>
            <td><?= $value['nama_kategori_lokasi'] ?></td>
          </tr>
          <?php endforeach ?>
          <?php if ($lokasi_kategori == NULL): ?>
            <tr>
