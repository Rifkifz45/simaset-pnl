                  ...
                  <div class="col-xs-12">
                     <div class="box">
                           ...
                           <div class="box-header">
                              ...
                              <div class="widget-box">
                                 <div class="widget-header">
                                    <h4 class="widget-title">Laporan Data Penempatan Bulanan</h4>
                                       ...
                                       <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                          ...
                                          <div class="col-xs-3">
                                             <select name="cmbTahun" style="width:100%">
                                                ...
                                                $thnSql = "SELECT MIN(LEFT(tgl_penempatan,4)) As tahun_kecil, MAX(LEFT(tgl_penempatan,4)) As tahun_besar FROM transaksi_penempatan";
                        ...
                        $db->table('transaksi_penempatan')
                           ...
                           ->where('LEFT(tgl_penempatan,4) = '. $cmbTahun . ' AND MID(tgl_penempatan, 6, 2) = ' . $cmbBulan)
                           ->get()
                           ->getResultArray();
                        ?>
                        <div class="box-body">
