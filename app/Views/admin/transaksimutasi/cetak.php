                        ...
                        <div class='row'>
                           <div class='col-xs-6'>
                              <table class='table table-condensed table-bordered input-sm'>
                                 <tbody>
                                    <tr>
                                       <th width='150px' scope='row'>No. Mutasi</th>
                                       <td>
                                          <?php echo $penempatan['idtransaksi_mutasi']; ?>
                                       </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <th scope='row'>Tanggal Mutasi</th>
                                       <td>
                                          <?php echo date("d-m-Y H:i:s", strtotime($penempatan['tgl_mutasi'])) . " WIB"; ?>
                                       </td>
                                    </tr>
                                    <tr>
                                       <th scope='row'>Lokasi Mutasi</th>
                                       <td>
                           ...
                           <div class='col-xs-8'>
                              <div class='widget-box'>
                                 <div class='widget-header'>
                                    <h4 class='widget-title'>DAFTAR BARANG</h4>
                                 ...
                                 <div class='widget-body'>
                                    <div class='widget-main'>
                                       <table id='dynamic-table1' class='table table-striped table-bordered table-hover' style="font-size:12px">
                                          <thead>
                                             <tr>
                                                <th width="35">No</th>
                                                <th>Kode</th>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                               <?php
                                               $db=\Config\Database::connect();
                                               $data = $db->table('transaksi_mutasi_asal')
                                               ->join('transaksi_penempatan', 'transaksi_penempatan.idtransaksi_penempatan = transaksi_mutasi_asal.idtransaksi_penempatan')
                                               ->join('transaksi_penempatan_item', 'transaksi_penempatan_item.idtransaksi_penempatan = transaksi_penempatan.idtransaksi_penempatan')
                                               ...
                                               ->where('idtransaksi_mutasi', $penempatan['idtransaksi_mutasi'])
                                               ->where('transaksi_mutasi_asal.idinventaris_peralatan', $value->idinventaris_peralatan)
                                               ->get()
                                               ->getRowArray();

                                               echo $data['nama_gedung'] . " Lantai " . $data['lantai'] . " - " . $data['nama_lokasi'];
                                               ?>
                                            </td>
