   ...
   <div class="main-content-inner">
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
         <ul class="breadcrumb">
            ...
            <li>
               <a href="<?= site_url('admin/statistik-group') ?>">Statistik</a>
            </li>
                  ...
                  <div class="col-xs-12">
                     <div class="widget-box">
                        <div class="widget-header">
                           <h4 class="widget-title">Group Data by <?= $detail['uraian'] ?></h4>
...
{ "mDataProp": "uraian","className": "text-center"},
{ "mDataProp": "jumlah","className": "text-center"},
{ "mDataProp": "satuan","className": "text-center"},
