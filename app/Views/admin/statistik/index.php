         ...
         <div class="row">
            <div class="col-md-6">
               <div class="panel panel-default">
                  ...
                  <a href="<?= site_url('admin/statistik-chart') ?>">
                                 ...
                                 <tr>
                                    ...
                                    <td class="center">
                                       <div class="action-buttons">
                                          <a href="<?= site_url('admin/statistik-group/extend/'.$value['idtweb_asset']) ?>" title="See Detail" class="green" href="#">
                                             <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                          </a>

                                          <a href="<?= site_url('admin/statistik-group/'.$value['idtweb_asset']) ?>" title="See Sub Detail" class="red" href="#">
