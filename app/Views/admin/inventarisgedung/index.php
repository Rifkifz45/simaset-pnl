      ...
      <div class="page-content">
         ...
         <div class="page-header">
            <h1>
               ...
               Management data Inventaris Gedung
               </small>
            </h1>
         </div>
         ...
         <div class="row">
            <div class="col-xs-12">
               ...
               <div class="clearfix">
                  <div class="pull-left">
                     <a href="<?= site_url('admin/inventaris_gedung/add') ?>" class="btn btn-sm btn-primary">
                     ...
                     <i class="ace-icon glyphicon glyphicon-import"></i> Import Gedung
                     </button>
                  </div>
               ...
               <?= $this->include('admin/inventarisgedung/modal-import') ?>
               <!-- PAGE CONTENT ENDS -->
            </div>
            <!-- /.col -->
         </div>
...
<?= $this->include('admin/inventarisgedung/script.js') ?>
<?= $this->endSection('') ?>