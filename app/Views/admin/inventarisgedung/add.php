	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="<?= site_url('admin/inventaris_gedung/create') ?>" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="dokumen" required type="text" class="form control input-xxlarge">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_bangunan" required type="text" class="form-control" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_dasar_bangunan" required type="text" class="form-control" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="jalan" type="text" class="form-control input-xxlarge" placeholder="Jalan" required>
							</div>
						</div>
						<div class="space-4"></div>
