                                 ...
                                 <div class="widget-body" style="display: block;">
                                    <div class="widget-main">
                                       ...
                                       <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                          <div class="col-xs-4">
                                             <select name="id_gedung" id="id_gedung" class="form-control chosen-select" style="width: 100%">
                                          ...
                                          <div class="col-xs-4">
                                             <select name="id_lokasi" id="id_lokasi" class="form-control chosen-select" style="width: 100%">
                        ...
                        ?>
                           ...
                           <div class="btn-group pull-left">
                              ...
                              <ul class="dropdown-menu" role="menu">
                                 <li><a href="javascript:void(0)" onclick="window.location.href='<?= site_url('admin/inventaris_ruangan/pdf/'.$id_lokasi) ?>';return false;">PDF</a></li>
                              </ul>
                           </div>
                           <!--export data -->	
                        </div>
