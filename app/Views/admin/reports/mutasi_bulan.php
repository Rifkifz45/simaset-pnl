                  ...
                  <div class="col-xs-12">
                     <div class="box">
                           ...
                           <div class="box-header">
                              ...
                              <div class="widget-box">
                                 <div class="widget-header">
                                    <h4 class="widget-title">Laporan Data Mutasi Bulanan</h4>
                                 ...
                                 <div class="widget-body" style="display: block;">
                                    <div class="widget-main">
                                       ...
                                       <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                          <div class="col-xs-3">
                                             <select name="cmbBulan" style="width:100%">
                                                <?php
                                                // Membuat daftar Nama Bulan
                                                $listBulan = array("00" => "....", "01" => "01. Januari", "02" => "02. Februari", "03" => "03. Maret", "04" => "04. April", "05" => "05. Mei", "06" => "06. Juni", "07" => "07. Juli", "08" => "08. Agustus", "09" => "09. September", "10" => "10. Oktober", "11" => "11. November", "12" => "12. Desember");

                                                // Menampilkan Nama Bulan ke ComboBox (List/Menu)
                                                foreach($listBulan as $bulanKe => $bulanNm) {
                                                   if ($bulanKe == date("m",strtotime(date('Y-m-d')))) {
                                                      $cek = " selected";
                                                   } else { $cek=""; }
                                          ...
                                          <div class="col-xs-3">
                                             <select name="cmbTahun" style="width:100%">
                                                <?php
                                                $db = \Config\Database::connect();
                                                # Baca tahun terendah(kecil), dan tahun tertinggi(besar) di tabel Transaksi
                                                $thnSql = "SELECT MIN(LEFT(tgl_mutasi,4)) As tahun_kecil, MAX(LEFT(tgl_mutasi,4)) As tahun_besar FROM transaksi_mutasi";

                                                $data = $db->query($thnSql)->getResultArray();

                                                // Membaca tahun
                                                $thnKecil = $data[0]['tahun_kecil'];
                                                $thnBesar = $data[0]['tahun_besar'];
                        ...
                        $db->table('transaksi_mutasi')
                           ...
                           ->where('LEFT(tgl_mutasi,4) = '. $cmbTahun . ' AND MID(tgl_mutasi, 6, 2) = ' . $cmbBulan)
                           ->get()
                           ->getResultArray();
                        ?>
                        <div class="box-body">
                           <p style="text-align:center; font-size: 15pt; font-weight: bold;"> Laporan Data Mutasi</p>
                           <p style="text-align:center; font-size: 10pt;">Periode <?= "Bulan" ?> s/d <?= "Tahun" ?> </p>
