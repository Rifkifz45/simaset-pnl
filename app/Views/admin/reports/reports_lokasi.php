...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>DAFTAR DATA LOKASI</title>
    <style>
      h1 {
      font-weight: bold;
      font-size: 16pt;
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><?= $value['id_lokasi'] ?></td>
             <td><?= $value['nama_lokasi'] ?></td>
             <td class="text-center"><?= $value['luas_lokasi'] ?> m<sup>2</sup></td>
             <td><?= $value['nama_kategori_lokasi'] ?></td>
             <td><?= $value['nama_gedung'] . " (Lantai " . $value['lantai'] ?></td>
          </tr>
          <?php endforeach ?>
          <?php if ($lokasi == NULL): ?>
            <tr>
