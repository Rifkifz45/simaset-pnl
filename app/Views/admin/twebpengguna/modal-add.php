  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="validation-form" action="<?= site_url('admin/pengguna/create') ?>" class="form-horizontal" method="POST">
          ...
          <div class="form-group">
	        <label for="foto" class="col-md-3 control-label">Upload Gambar : </label>
	        <div class="col-md-7">
