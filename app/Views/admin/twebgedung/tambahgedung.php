	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li>
					<a href="<?= site_url('admin/gedung') ?>">Gedung</a>
				</li>
					      ...
					      <form id="validation-form" action="<?= site_url('admin/gedung/create') ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
					         <div class='widget-box'>
					            <div class='widget-header'>
					               <h4 class='widget-title'>TAMBAH DATA GEDUNG</h4>
					               <div class='widget-toolbar'>
					                  <button class='btn btn-minier btn-primary' type='submit' name='submit'><i class='ace-icon fa fa-save'></i>Save </button>
					                  <button class='btn btn-minier btn-info' onclick="window.location.href='<?= site_url('admin/gedung') ?>'"><i class='ace-icon fa fa-undo'></i>Back</button>
					                  ...
					                  <table class='table table-condensed table-bordered input-sm'>
					                     <tbody>
					                        <tr>
					                           ...
					                           <td><input type="hidden" id="foto_gedung_lama" name="foto_gedung_lama">
					                           	<input value="<?= $dataKode ?>" type="text" id="id_gedung" name="id_gedung" required placeholder=" Kode Gedung" value="" class="form-control" readonly>
					                           </td>
					                        </tr>
					                        <tr>
					                           <th scope='row'>Nama Gedung</th>
					                           <td>
					                           	<input onfocus="this.setSelectionRange(this.value.length,this.value.length);" autofocus id="nama_gedung" type="text" name="nama_gedung" required placeholder=" Masukan Nama Gedung" class="form-control">
					                           </td>
					                        </tr>
					                        <tr>
					                           <th scope='row'>Latitude</th>
					                           <td>
					                           	<input onkeydown="event.preventDefault()" data-readonly id="latitude" type="text" name="latitude" required placeholder=" Masukan Latitude" class="form-control">
					                           </td>
					                        </tr>
					                        <tr>
					                           <th scope='row'>Longitude</th>
					                           <td>
					                           	<input onkeydown="event.preventDefault()" data-readonly id="longitude" type="text" name="longitude" required placeholder=" Masukan Longitude" class="form-control">
					                           </td>
					                        </tr>
					                        <tr>
