			...
			<div class="page-header">
				<h1>
					...
					<small>
						...
						Distribusi awal Barang untuk DBR & DBL
					</small>
				</h1>
			</div><!-- /.page-header -->
				...
				<div class="col-xs-12">
	               ...
	               <div class="clearfix">
	                  <div class="pull-right" style="margin-left: 15px;">
	                     <a href="<?= site_url('admin/penempatan/new') ?>" type="button" class="btn btn-sm btn-primary">
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td><?= $key + 1 ?></td>
								<td><?= date("d-m-Y H:i:s", strtotime($value['tgl_penempatan'])) ?></td>
								...
								<td class="text-center">
									<a data-toggle="tooltip" rel="tooltip" data-placement="top" type="button" class="btn btn-xs btn-success 
									<?= ($value['status_penempatan'] == "Accepted") ? "Disabled" : null ?>
									<?= ($value['status_penempatan'] == "Rejected") ? "Disabled" : null ?>
									" href="<?= site_url('admin/penempatan/detail/'.$value['idtransaksi_penempatan']) ?>" title="Detail Data"><i class="ace-icon fa fa-folder-open-o bigger-120"></i></a>

									<a data-toggle="modal" data-target="#delete<?php echo $value['idtransaksi_penempatan'] ?>" data-toggle="tooltip" rel="tooltip" data-placement="top" type="button" class="btn btn-xs btn-danger <?= ($value['status_penempatan'] == "Accepted") ? "Disabled" : null ?>
									<?= ($value['status_penempatan'] == "Rejected") ? "Disabled" : null ?>
									" title="Delete Data"><i class="ace-icon fa fa-trash bigger-120"></i></a>

									<a target="_blank" href="<?= site_url('admin/penempatan/cetak/'.$value['idtransaksi_penempatan']) ?>" data-toggle="tooltip" rel="tooltip" data-placement="top" type="button" class="btn btn-xs btn-info 
									<?= ($value['status_penempatan'] == "Accepted") ? "Disabled" : null ?>
									<?= ($value['status_penempatan'] == "Rejected") ? "Disabled" : null ?>
									" title="Print Data"><i class="ace-icon fa fa-print bigger-120"></i></a>
                                </td>
							</tr>
								<?php endforeach ?>
							</tbody>
