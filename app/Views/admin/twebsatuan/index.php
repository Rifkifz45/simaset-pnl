                  ...
                  <div class="col-xs-12">
                     <div class="widget-box">
                        <div class="widget-header">
                           <h4 class="widget-title">TWEB SATUAN</h4>
                                       ...
                                       <tr>
                                          ...
                                          <td class="center">
                                             <div class="action-buttons">
                                                <a data-toggle="modal" data-target="#edit<?= $value['id_satuan'] ?>" title="Edit" class="green" href="#">
                                                   <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a data-toggle="modal" data-target="#delete<?= $value['id_satuan'] ?>" title="Delete" class="red" href="#">
...
<?= $this->include('admin/twebsatuan/script.js') ?>
<?= $this->endSection('') ?>