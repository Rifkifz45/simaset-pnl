	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" method="post" action="<?= site_url('admin/inventaris_tanah/update') ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kode Barang </label>
							<input value="<?= $detail['id'] ?>" type="hidden" name="idinventaris_tanah">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="jenis_dokumen" value="<?= $detail['jenis_dokumen'] ?>" required type="text" class="form control input-xxlarge">
							</div>
						</div>
						<div class="space-4"></div>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kepemilikan </label>

							<div class="col-sm-9">
								<textarea required name="kepemilikan" id="kepemilikan" class="form-control input-xxlarge"><?= $detail['kepemilikan'] ?></textarea>
							</div>
						</div>
						<div class="space-4"></div>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis Sertifikat </label>

							<div class="col-sm-9">
								<input name="jenis_sertifikat" value="<?= $detail['jenis_sertifikat'] ?>" required type="text" class="form control input-xxlarge">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Luas Tanah Seluruhnya </label>

							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input value="<?= number_format($detail['luas_tanah_seluruhnya']) ?>" type="text" class="form-control" name="luas_tanah_seluruhnya" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Luas Tanah Untuk Bangunan </label>

							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_tanah_untuk_bangunan" value="<?= number_format($detail['luas_tanah_untuk_bangunan']) ?>" type="text" class="form-control" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Luas tanah Untuk Sarana Lingkungan </label>

							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_tanah_untuk_sarana_lingkungan" value="<?= number_format($detail['luas_tanah_untuk_sarana_lingkungan']) ?>" type="text" class="form-control" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Luas Lahan Kosong </label>

							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_lahan_kosong" value="<?= number_format($detail['luas_lahan_kosong']) ?>" type="text" class="form-control" placeholder="Masukan Luas dalam m2" required>
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea name="alamat" id="alamat" placeholder="Letak / Alamat" class="form-control input-xxlarge" required><?= $detail['alamat'] ?></textarea>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="rt_rw" value="<?= $detail['rt_rw'] ?>" type="text" class="form-control input-xxlarge" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="desa" value="<?= $detail['desa'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kelurahan / Desa" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kecamatan" value="<?= $detail['kecamatan'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kecamatan" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kabkot" value="<?= $detail['kabkot'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kabkot" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kode_kabkot" value="<?= $detail['kode_kabkot'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kode Kabkot" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="provinsi" value="<?= $detail['provinsi'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Provinsi" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kode_provinsi" value="<?= $detail['kode_provinsi'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kode Provinsi" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kode_pos" value="<?= $detail['kode_pos'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kode Pos" required>
							</div>
						</div>
						<div class="space-4"></div>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Alamat Lainnya </label>

							<div class="col-sm-9">
								<textarea name="alamat_lainnya" id="alamat_lainnya" placeholder="Letak / Alamat" class="form-control input-xxlarge" required><?= $detail['alamat_lainnya'] ?></textarea>
							</div>
						</div>
						<div class="space-4"></div>
