  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form onSubmit="if(!confirm('Yakin ingin mengupload file ini?')){return false;}" id="validation-form" action="<?= site_url('admin/inventaris_tanah/import') ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
