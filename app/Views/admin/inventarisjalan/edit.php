	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" method="post" action="<?= site_url('admin/inventaris_jalan/update') ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kode Barang </label>
							<input value="<?= $detail['idinventaris_jalan'] ?>" type="hidden" name="idinventaris_jalan">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input value="<?= number_format($detail['luas_bangunan']) ?>" type="text" class="form-control" name="luas_tanah_seluruhnya" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_dasar_bangunan" value="<?= number_format($detail['luas_dasar']) ?>" type="text" class="form-control" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
