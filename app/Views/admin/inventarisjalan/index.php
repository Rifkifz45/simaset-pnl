      ...
      <div class="page-content">
         ...
         <div class="page-header">
            <h1>
               ...
               Management data Inventaris Jalan
               </small>
            </h1>
         </div>
         ...
         <div class="row">
            <div class="col-xs-12">
               ...
               <div class="clearfix">
                  <div class="pull-left">
                     <a href="<?= site_url('admin/inventaris_jalan/add') ?>" class="btn btn-sm btn-primary">
                     ...
                     <i class="ace-icon glyphicon glyphicon-import"></i> Import Jalan
                     </button>
                  </div>
               ...
               <?= $this->include('admin/inventarisjalan/modal-import') ?>
               <!-- PAGE CONTENT ENDS -->
            </div>
            <!-- /.col -->
         </div>
...
<?= $this->include('admin/inventarisjalan/script.js') ?>
<?= $this->endSection('') ?>