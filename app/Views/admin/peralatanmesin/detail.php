	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li>
					<a href="javascript:history.go(-2)">Master Assets</a>
				</li>
				<li>
					<a href="javascript: window.history.back();">Peralatan dan Mesin</a>
				</li>
				<li class="active">View Data A</li>
			</ul><!-- /.breadcrumb -->
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="table-header">
						12 Results for "Peralatan dan Mesin"
					</div>
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th> Kondisi </th>
									<th> Merk / Tipe </th>
									<th> Tanggal Rekam Pertama </th>
									<th> Tanggal Perolehan </th>
									<th> Nilai Perolehan Pertama </th>
									<th> Nilai Mutasi </th>
