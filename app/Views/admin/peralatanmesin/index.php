	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li>
					<a href="javascript:history.back()">Master Assets</a>
				</li>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="table-header">
						Results for "Peralatan dan Mesin"
					</div>
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th> Fields Code </th>
									<th> Field Name </th>
									<th class="hidden-480"> Count Data </th>
									<th>
								...
								<tr>
									...
									<td class="hidden-480 center">
										<?php
				                          ...
				                          $query = $db->table('tabel-master-plm')->where(['fields_id' => $value['fields_id']]);
				                          echo $query->countAllResults();
				                         ?>
									</td>
									<td class="center">
										<div class="hidden-sm hidden-xs btn-group">
											<a href="<?= site_url('admin/peralatan-mesin/view-data/'.$value['fields_id']) ?>" class="btn btn-sm btn-success">
												<i class="ace-icon fa fa-search-plus bigger-120"></i> View
											</a>
										</div>
									</td>
								</tr>
