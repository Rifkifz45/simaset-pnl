				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly value="<?= $detail['jenis_dokumen'] ?>" required type="text" class="form control input-xxlarge">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea readonly required name="" id="" class="form-control input-xxlarge"><?= $detail['kepemilikan'] ?></textarea>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly value="<?= $detail['jenis_sertifikat'] ?>" required type="text" class="form control input-xxlarge">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input value="<?= number_format($detail['luas_tanah_seluruhnya']) ?>" readonly type="text" class="form-control" id="luas" name="luas" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input value="<?= number_format($detail['luas_tanah_untuk_bangunan']) ?>" readonly type="text" class="form-control" id="luas" name="luas" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input value="<?= number_format($detail['luas_tanah_untuk_sarana_lingkungan']) ?>" readonly type="text" class="form-control" id="luas" name="luas" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input value="<?= number_format($detail['luas_lahan_kosong']) ?>" readonly type="text" class="form-control" id="luas" name="luas" placeholder="Masukan Luas dalam m2" required>
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea readonly name="" id="" placeholder="Letak / Alamat" class="form-control input-xxlarge" required><?= $detail['alamat'] ?></textarea>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly value="<?= $detail['rt_rw'] ?>" type="text" class="form-control input-xxlarge" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly value="<?= $detail['desa'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kelurahan / Desa" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly value="<?= $detail['kecamatan'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kecamatan" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly value="<?= $detail['kabkot'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kabkot" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly value="<?= $detail['provinsi'] ?>" type="text" class="form-control input-xxlarge"  placeholder="Masukan Provinsi" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea readonly name="" id="" placeholder="Letak / Alamat" class="form-control input-xxlarge" required><?= $detail['alamat_lainnya'] ?></textarea>
							</div>
						</div>
						<div class="space-4"></div>
