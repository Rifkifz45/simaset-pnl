	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="<?= site_url('admin/inventaris_tanah/create') ?>" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="jenis_dokumen" required type="text" class="form control input-xxlarge">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea required name="kepemilikan" id="kepemilikan" class="form-control input-xxlarge"></textarea>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="jenis_sertifikat" required type="text" class="form control input-xxlarge">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_tanah_seluruhnya" required type="text" class="form-control" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_tanah_untuk_bangunan" required type="text" class="form-control" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_tanah_untuk_sarana_lingkungan" required type="text" class="form-control" placeholder="Masukan Luas dalam m2">
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group input-xxlarge">
									<input name="luas_lahan_kosong" type="text" class="form-control" placeholder="Masukan Luas dalam m2" required>
									<span class="input-group-addon">M<sup>2</sup></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea name="alamat" id="alamat" placeholder="Letak / Alamat" class="form-control input-xxlarge" required></textarea>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="rt_rw" type="text" class="form-control input-xxlarge"  placeholder="Masukan RT / RW" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="desa" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kelurahan / Desa" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kecamatan" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kecamatan" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kabkot" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kabkot" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kode_kabkot" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kode Kabkot" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="provinsi" type="text" class="form-control input-xxlarge"  placeholder="Masukan Provinsi" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kode_provinsi" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kode Provinsi" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="kode_pos" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kode Pos" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea name="alamat_lainnya" id="alamat_lainnya" placeholder="Letak / Alamat" class="form-control input-xxlarge" required></textarea>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="jumlah_kib" type="text" class="form-control input-xxlarge"  placeholder="Jumlah KIB" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="sbsk" type="text" class="form-control input-xxlarge"  placeholder="SBSK" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="optimalisasi" type="text" class="form-control input-xxlarge"  placeholder="Masukan Kode Pos" required>
							</div>
						</div>
						<div class="space-4"></div>
