                  ...
                  <div class="col-xs-12">
                     <div class="widget-box">
                        <div class="widget-header">
                           <h4 class="widget-title">TWEB LOKASI LIST</h4>
                        ...
                        <div class="widget-body">
                           <div class="widget-main">
                              ...
                              <form action="<?= site_url('admin/lokasi/printlist/'.$lokasi['id_lokasi']) ?>" method="post" target="_blank">
                              	<div class="clearfix">
                                 ...
                                 <table id="dynamic-table" class="table table-striped table-bordered dataTable no-footer">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td class="center">
                                          <label class="pos-rel">
                                          	<input class="ace" name="cbKode[]" id="cbKode" value="<?= $value['idinventaris_peralatan'] ?>" type="checkbox">
                                          	<span class="lbl"></span>
                                          </label>
                                       </td>
                                       </tr>
