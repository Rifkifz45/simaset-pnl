			...
			<div class="row">
				...
				<div class="col-xs-12">
                    ...
                    ?>
									...
									<td class="center">
										<div class="btn-group">
											<a href="<?= site_url('admin/lokasi/group/') ?>" data-toggle="tooltip" data-placement="top" rel="tooltip" title="Detail" class="btn btn-xs btn-success">
                       <i class="ace-icon glyphicon glyphicon-folder-open"></i> Detail
                       </a>
                       <a href="<?= site_url('admin/lokasi/group/') ?>" data-toggle="tooltip" data-placement="top" rel="tooltip" title="Sub Category" class="btn btn-xs btn-info">
                       <i class="ace-icon glyphicon glyphicon-folder-open"></i> Open
                       </a>
                    </div>
									</td>
								</tr>
