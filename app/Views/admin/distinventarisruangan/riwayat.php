	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li>
					<a href="<?= site_url('admin/inventaris_ruangan') ?>">Daftar Barang Ruangan</a>
				</li>
				<li class="active"><?= $check['kode_barang'] . " - " . $check['nup'] ?></li>
			</ul><!-- /.breadcrumb -->
                  ...
                  <div class="col-xs-12">
                     <div class="widget-box">
                        <div class="widget-header">
                           <h4 class="widget-title">RIWAYAT BARANG</h4>
                           ...
                           <div class="widget-main">
                           		...
                           		<table class="table table-bordered table-striped" style="width:50%">
	                                 ...
	                                 <tbody>
	                                    <tr>
	                                       <td>Kode Barang</td>
	                                       <td><code><?= $check['kode_barang'] ?></code></td>
	                                    </tr>
	                                    <tr>
	                                       <td>Nama Barang</td>
	                                       <td><code><?= $check['nama_barang'] ?></code></td>
	                                    </tr>
	                                    <tr>
	                                       <td>NUP</td>
	                                       <td><code><?= $check['nup'] ?></code></td>
	                                    </tr>
	                                 </tbody>
	                              </table>
                                 ...
                                 <tbody>
	                              ...
	                              <tr>
	                                 ...
	                                 <td class="center"><?= $value['nama_pengguna'] ?></td>
	                              </tr>
	                              <?php endforeach ?>
                                 </tbody>
                              </table>
