				  ...
				  <div class="panel panel-default">
				    <div class="panel-body">
				      <table width="100%">
						...
						<table width="100%">
						  <tr>
						    <td colspan="7" style="text-align: center"><strong><h4>DAFTAR INVENTARIS RUANGAN</h4></strong><strong><h4>POLITEKNIK NEGERI LHOKSEUMAWE</h4></strong></td>
						  </tr>
						</table>
						...
						<table>
							<?php
	                     	...
	                     	?>
							<tr>
								<td width="110px"><b>Kode Ruangan</b></td>
								<td width="10px"> : </td>
								<td width="300px"><?= $query->id_lokasi ?></td>
							</tr>
							<tr>
								<td width="110px"><b>Nama Gedung</b></td>
								<td width="10px"> : </td>
								<td width="300px"><?= $query->nama_gedung ?></td>
							</tr>
							<tr>
								<td width="110px"><b>Nama Ruangan</b></td>
								<td width="10px"> : </td>
