         ...
         <div class="row">
            <div class="col-xs-12">
               ...
               <div class="table-header">
                  <span class="text-left"><?= count($hak) ?> Data Available in field "Hak"</span>
               </div>
               <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="center">
                              <div class="btn-group">
                                <a data-toggle="modal" data-target="#edit<?= $value['id_hak'] ?>" data-toggle="tooltip" data-placement="top" rel="tooltip" title="Edit" class="btn btn-xs btn-info">
                                <i class="ace-icon glyphicon glyphicon-edit"></i>
                                </a>
                                <a data-toggle="modal" data-target="#delete<?= $value['id_hak'] ?>" data-toggle="tooltip" data-placement="top" rel="tooltip" title="Delete" class="btn btn-xs btn-danger">
               ...
               <?= $this->include('admin/twebhak/modal-add') ?>
               <?= $this->include('admin/twebhak/modal-edit') ?>
               <?= $this->include('admin/twebhak/modal-delete') ?>
               <!-- PAGE CONTENT ENDS -->
            </div>
            <!-- /.col -->
         </div>
