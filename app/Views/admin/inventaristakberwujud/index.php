      ...
      <div class="page-content">
         ...
         <div class="row">
            <div class="col-xs-12">
               ...
               <div class="clearfix">
                  <div class="pull-left">
                     <a href="<?= site_url('admin/inventaris_takberwujud/add') ?>" class="btn btn-sm btn-primary">
               ...
               <?= $this->include('admin/inventaristakberwujud/modal-import') ?>
               <!-- PAGE CONTENT ENDS -->
            </div>
            <!-- /.col -->
         </div>
...
<?= $this->include('admin/inventaristakberwujud/script.js') ?>
<?= $this->endSection('') ?>