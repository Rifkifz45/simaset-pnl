	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" method="post" action="<?= site_url('admin/inventaris_takberwujud/update') ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kode Barang </label>
							<input value="<?= $detail['idinventaris_takberwujud'] ?>" type="hidden" name="idinventaris_takberwujud">
