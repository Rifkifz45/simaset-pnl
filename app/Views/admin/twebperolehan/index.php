                                 ...
                                 <tr>
                                    ...
                                    <td class="center">
                                       <div class="action-buttons">
                                          <a data-toggle="modal" data-target="#edit<?= $value['id_perolehan'] ?>" title="Edit" class="green" href="#">
                                             <i class="ace-icon fa fa-pencil bigger-130"></i>
                                          </a>

                                          <a data-toggle="modal" data-target="#delete<?= $value['id_perolehan'] ?>" title="Delete" class="red" href="#">
