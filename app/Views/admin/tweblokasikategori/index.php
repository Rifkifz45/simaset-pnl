	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Lokasi Kategori</li>
			</ul>
			<!-- /.breadcrumb -->
              ...
              <div class="col-xs-12">
                 <div class="widget-box">
                    <div class="widget-header">
                       <h4 class="widget-title">TWEB LOKASI KATEGORI</h4>
                          ...
                          <div>
                             <table id="dynamic-table" class="table table-striped table-bordered dataTable no-footer">
                              ...
                              <?php foreach ($kategori as $key => $value): ?>
							                       ...
							                       <a title="Edit" data-toggle="modal" data-target="#edit<?= $value['id_kategori_lokasi'] ?>" class="green" href="#">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>
																		<a title="Delete" data-toggle="modal" data-target="#delete<?= $value['id_kategori_lokasi'] ?>" class="red" href="#">
