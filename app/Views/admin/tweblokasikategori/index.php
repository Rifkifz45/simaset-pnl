				...
				<div class="col-xs-12">
					...
					<div class="clearfix">
						<div class="pull-right" style="margin-left: 15px;">
							<button type="button" data-toggle="modal" data-target="#add" class="btn btn-sm btn-primary">
					...
					<div class="table-header">
						<span class="text-left"><?= count($kategori) ?> Data Available in field "Kategori Lokasi"</span>
					</div>
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="center"><?= $value['id_kategori_lokasi'] ?></td>
									<td><?= $value['nama_kategori_lokasi'] ?></td>
									<td class="center" style="width: 20%;">
										 <div class="btn-group">
                       <a data-toggle="modal" data-target="#edit<?= $value['id_kategori_lokasi'] ?>" data-toggle="tooltip" data-placement="top" rel="tooltip" title="Edit" class="btn btn-xs btn-info">
                       <i class="ace-icon glyphicon glyphicon-edit"></i>
                       </a>
                       <a data-toggle="modal" data-target="#delete<?= $value['id_kategori_lokasi'] ?>" data-toggle="tooltip" data-placement="top" rel="tooltip" title="Delete" class="btn btn-xs btn-danger">
					...
					<?= $this->include('admin/tweblokasikategori/modal-add') ?>
					<?= $this->include('admin/tweblokasikategori/modal-edit') ?>
					<?= $this->include('admin/tweblokasikategori/modal-delete') ?>
					<!-- PAGE CONTENT ENDS -->
				</div>
				<!-- /.col -->
			</div>
