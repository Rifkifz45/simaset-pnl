	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="<?= site_url('admin/inventaris_peralatan/create') ?>" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="no_bpkb" type="text" class="form-control input-xxlarge"  placeholder="No BPKB" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="no_polisi" type="text" class="form-control input-xxlarge"  placeholder="No Polisi" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="pemakai" type="text" class="form-control input-xxlarge"  placeholder="Pemakai" required>
							</div>
						</div>
						<div class="space-4"></div>
