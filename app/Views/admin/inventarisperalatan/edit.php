	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" method="post" action="<?= site_url('admin/inventaris_peralatan/update') ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kode Barang </label>
							<input value="<?= $detail['idinventaris_peralatan'] ?>" type="hidden" name="idinventaris_peralatan">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> NO. BPKB </label>

							<div class="col-sm-9">
								<input value="<?= $detail['no_bpkb'] ?>" name="no_bpkb" type="text" class="form-control input-xxlarge"  placeholder="No BPKB" required>
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input value="<?= $detail['no_polisi'] ?>" name="no_polisi" type="text" class="form-control input-xxlarge"  placeholder="No Polisi" required>
							</div>
						</div>
						<div class="space-4"></div>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pemakai </label>

							<div class="col-sm-9">
								<input value="<?= $detail['pemakai'] ?>" name="pemakai" type="text" class="form-control input-xxlarge" placeholder="Pemakai" required>
							</div>
						</div>
						<div class="space-4"></div>
