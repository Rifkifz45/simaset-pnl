  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form onSubmit="if(!confirm('Yakin ingin mengupload file ini?')){return false;}" id="validation-form" action="<?= site_url('admin/inventaris_asset/import') ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              <select name="opsi" class="form-control" id="opsi" required style="width: 100%;">
                ...
                <option value="1">Aset Tetap Lainnya</option>
              </select>
            </div>
          </div>
        </div>
