      ...
      <div id="main-content">
        ...
        <div id="page-content" style="margin-top: 50px;">
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-8">
                <form method="post" action="<?= site_url('reset_pw/verify') ?>">
                  <div class="row">
                    <div class="col-9">
            ...
            <br>
            <div class="text-info">
              A link will be sent to your email containing the information you need for your password. <br>Please <a style="text-decoration: none;" href="<?= site_url('page-login') ?>">Click here</a> to return to the login page
            </div>
          </div>
        </div>
