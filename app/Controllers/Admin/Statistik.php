...
class Statistik Extends BaseController{
	...
	public function detail1($id)
	{
		...
		if ($idtweb_asset["golongan"] == 2) {
			$db_select = site_url('admin/statistik/peralatan/'.$id);
		...
		return view('admin/statistik/subgroup',[
			'detail' => $idtweb_asset,
			'select' => $select,
			'barang' => $db_select
		]);
	...
	public function view($id){
		$idtweb_asset = $this->MTwebCategory->find($id);
		if ($idtweb_asset["golongan"] == 2) {
			$db_select = site_url('admin/statistik/DI_tanah/'.$id);
			$return_view = 'admin/statistik/view-tanah';
		} else if ($idtweb_asset["golongan"] == 3) {
			$db_select = site_url('admin/statistik/DI_peralatan/'.$id);
			$return_view = 'admin/statistik/view-peralatan';
		} else if ($idtweb_asset["golongan"] == 4) {
			$return_view = 'admin/statistik/view-gedung';
			$db_select = site_url('admin/statistik/DI_gedung/'.$id);
		} else if ($idtweb_asset["golongan"] == 5) {
			$return_view = 'admin/statistik/view-jalan';
			$db_select = site_url('admin/statistik/DI_jalan/'.$id);
		} else if ($idtweb_asset["golongan"] == 6) {
			$db_select = site_url('admin/statistik/DI_asset/'.$id);
			$return_view = 'admin/statistik/view-asset';
		} else if ($idtweb_asset["golongan"] == 7) {
			$db_select = site_url('admin/statistik/DI_konstruksi/'.$id);
		} else if ($idtweb_asset["golongan"] == 8) {
			$return_view = 'admin/statistik/view-takberwujud';
			$db_select = site_url('admin/statistik/DI_takberwujud/'.$id);
		} else{
			$db_select = 0;
		}
        ...
        if ($request->isAJAX()) {            
            ...
            ->add('action', function($row){
            	if ($row->golongan == 2) {
	                ...
	                <a target="_blank" href="'.site_url('admin/inventaris_tanah/sub/'.$row->idtweb_asset).'" title="Detail" class="primary"><i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
	                </div>
					';
                } else if ($row->golongan == 3) {
                	return '
                	<div class="action-buttons">
	                <a target="_blank" href="'.site_url('admin/inventaris_peralatan/sub/'.$row->idtweb_asset).'" title="Detail" class="primary"><i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
	                </div>
					';
                } else if ($row->golongan == 4) {
                	return '
                	<div class="action-buttons">
	                <a target="_blank" href="'.site_url('admin/inventaris_gedung/sub/'.$row->idtweb_asset).'" title="Detail" class="primary"><i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
	                </div>
					';
                } else if ($row->golongan == 5) {
                	return '
                	<div class="action-buttons">
	                <a target="_blank" href="'.site_url('admin/inventaris_jalan/sub/'.$row->idtweb_asset).'" title="Detail" class="primary"><i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
	                </div>
					';
                } else if ($row->golongan == 6) {
                	return '
                	<div class="action-buttons">
	                <a target="_blank" href="'.site_url('admin/inventaris_asset/sub/'.$row->idtweb_asset).'" title="Detail" class="primary"><i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
	                </div>
					';
                } else if ($row->golongan == 7) {
                	return '
                	<div class="action-buttons">
	                <a target="_blank" href="'.site_url('admin/inventaris_konstruksi/sub/'.$row->idtweb_asset).'" title="Detail" class="primary"><i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
	                </div>
					';
                } else if ($row->golongan == 8) {
                	return '
                	<div class="action-buttons">
	                <a target="_blank" href="'.site_url('admin/inventaris_takberwujud/sub/'.$row->idtweb_asset).'" title="Detail" class="primary"><i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
	                </div>
					';
                } else{
                	return "None";
	...
	public function index2()
	{
        ...
        return view('admin/statistik/index2',[
