...
class SubInventaris Extends BaseController{
    ...
    public function sub($id){
        ...
        if ($idtweb_asset["golongan"] == 2) {
            $db_select = site_url('approver/statistik/tanahv1/'.$id);
            $return_view = 'approver/statistik/view-tanahv1';
        } else if ($idtweb_asset["golongan"] == 3) {
            $db_select = site_url('approver/statistik/peralatanv1/'.$id);
            $return_view = 'approver/statistik/view-peralatanv1';
        } else if ($idtweb_asset["golongan"] == 4) {
            $return_view = 'approver/statistik/view-gedungv1';
            $db_select = site_url('approver/statistik/gedungv1/'.$id);
        } else if ($idtweb_asset["golongan"] == 5) {
             $return_view = 'approver/statistik/view-jalanv1';
            $db_select = site_url('approver/statistik/jalanv1/'.$id);
        } else if ($idtweb_asset["golongan"] == 6) {
             $return_view = 'approver/statistik/view-assetv1';
            $db_select = site_url('approver/statistik/assetv1/'.$id);
        } else if ($idtweb_asset["golongan"] == 7) {
             $return_view = 'approver/statistik/view-konstruksiv1';
            $db_select = site_url('approver/statistik/konstruksiv1/'.$id);
        } else if ($idtweb_asset["golongan"] == 8) {
             $return_view = 'approver/statistik/view-takberwujudv1';
            $db_select = site_url('approver/statistik/takberwujudv1/'.$id);
        } else{
            $db_select = 0;
        }
