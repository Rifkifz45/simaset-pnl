...
class Reports Extends BaseController{
    ...
    public function penempatan_periode(){
    	return view('approver/reports/penempatan_periode');
    }

    public function penempatan_bulan(){
    	return view('approver/reports/penempatan_bulan');
    }

    public function penempatan_lokasi(){
    	$gedung = $this->MTwebGedung->findAll();
    	return view('approver/reports/penempatan_lokasi',[
    		'gedung' => $gedung
    	]);
    }

    public function mutasi_periode(){
    	return view('approver/reports/mutasi_periode');
    }

    public function mutasi_bulan(){
    	return view('approver/reports/mutasi_bulan');
    }

    public function mutasi_lokasi(){
    	$gedung = $this->MTwebGedung->findAll();
    	return view('approver/reports/mutasi_lokasi',[
    		'gedung' => $gedung
    	]);
    }
    ...
    public function penempatan_ruangan(){
    	$gedung = $this->MTwebGedung->findAll();
    	return view('approver/reports/penempatan_ruangan',[
    		'gedung' => $gedung
    	]);
    }
    ...
    public function penempatan_lainnya(){
    	$gedung = $this->MTwebGedung->findAll();
    	return view('approver/reports/penempatan_lainnya',[
    		'gedung' => $gedung
    	]);
    }		
    ...
    public function kib_tanah(){
        ...
        $data = view('approver/reports/tanah_index',[
            'tanah'   =>  $tanah
        ]);
	...
	public function kib_alatbesar(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/alatbesar_index',[
            'alatbesar'   =>  $alatbesar
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function kib_alatangkut(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/alatangkut_index',[
            'alatbesar'   =>  $alatbesar
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function kib_alatsenjata(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/alatsenjata_index',[
	...
	public function kib_bangunangedung(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/bangunangedung_index',[
	...
	public function kib_bangunanair(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/bangunanair_index',[
	...
	public function reports_gedung(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_gedung',[
            'gedung'   =>  $gedung
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function reports_lokasi(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_lokasi',[
            'lokasi'   =>  $lokasi
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function reports_lokasi_kategori(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_lokasi_kategori',[
	...
	public function reports_kategori(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_kategori',[
            'kategori'   =>  $kategori
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function reports_kondisi(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_kondisi',[
            'kondisi'   =>  $kondisi
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function reports_satuan(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_satuan',[
            'satuan'   =>  $satuan
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function reports_hak(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_hak',[
            'hak'   =>  $hak
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function reports_perolehan(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_perolehan',[
            'perolehan'   =>  $perolehan
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function reports_pengguna(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_pengguna',[
            'pengguna'   =>  $pengguna
        ]);
        $mpdf->setFooter('{PAGENO}');
        $mpdf->WriteHTML($data);
	...
	public function reports_pengguna_kategori(){
		...
		$mpdf = new \Mpdf\Mpdf();
        $this->response->setContentType('application/pdf');
        $data = view('approver/reports/reports_pengguna_kategori',[
